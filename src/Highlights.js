    ...
    return (
        <div className='highlights'>
            <div className='highlightsTop'>
                ...
                <button aria-label="On Click" className='buttonHighlights'>ONLINE MENU</button>
            </div>
            <div className='highlightsBottom'>
                <div className='item item1'>
                    ...
                    <br></br>
                    <a aria-label="On Click" className="deliveryLink" href="orderAdelivery">Order a delivery</a>
                </div>
